...
\title{Analisis de personas Indiginas que llegaron a UCI}
...
%
\begin{abstract}
In this scientific article, we will focus on the analysis of Covid-19 data in Mexico, using techniques such as K-means, autoencoder, and PCA for dimensionality reduction and the search for different types of patterns.
The combination of advanced data analysis techniques will allow us to explore the complexity of this data, identify underlying patterns and obtain valuable information for decision making.

By gaining a deeper insight into the Covid-19 data in Mexico, we will be able to better understand the factors that contribute to the spread of the disease, the effectiveness of control measures, and the disparities in the impact of different population groups.
...
\begin{keywords}
Covid-19, Mexico, Analysis of data, patterns, dimensionality reduction, PCA.
\end{keywords}
